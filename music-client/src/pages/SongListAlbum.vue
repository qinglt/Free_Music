    ...
    <div class="album-body">
      ...
      <div class="album-content">
        ...
        <div class="album-score">
          ...
          <div>
            <h3>评价：</h3>
            <div @click="pushValue()" v-if="!disabledRank">
              <el-rate v-model="value3" show-text allow-half></el-rate>
            </div>
            <div v-else>
              <el-rate v-model="value3" show-text allow-half disabled></el-rate>
            </div>
          </div>
        </div>
        <!--歌曲-->
...
export default {
  ...
  methods: {
    ...
    // 获取用户评分
    getUserRank (id, id2) {
      this.$api.rankAPI.getUserRank(id, id2)
        .then(res => {
          this.value3 = res.data * 0.5
          if (this.value3 !== 0) {
